...
/**
 *  SubscriptionResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SubscriptionResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://cs.umu.se/edu/soa/hws/stubs",
            "SubscriptionResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SubscriptionResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SubscriptionResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SubscriptionResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubscriptionResponse object = new SubscriptionResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubscriptionResponse".equals(type)) {
                            ...
                            return (SubscriptionResponse) se.umu.cs.edu.soa.hws.stubs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setResponse(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
