...
/**
 *  GreetResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GreetResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GreetResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GreetResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GreetResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GreetResponse object = new GreetResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GreetResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GreetResponse) se.umu.cs.edu.soa.hws.stubs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
