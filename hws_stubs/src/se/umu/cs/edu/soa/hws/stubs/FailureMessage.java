...
/**
 *  FailureMessage bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class FailureMessage implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":FailureMessage", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "FailureMessage", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static FailureMessage parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FailureMessage object = new FailureMessage();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FailureMessage".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FailureMessage) se.umu.cs.edu.soa.hws.stubs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
