...
/**
 *  Acknowledgement bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Acknowledgement implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Acknowledgement", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Acknowledgement", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Acknowledgement parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Acknowledgement object = new Acknowledgement();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Acknowledgement".equals(type)) {
                            ...
                            return (Acknowledgement) se.umu.cs.edu.soa.hws.stubs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
