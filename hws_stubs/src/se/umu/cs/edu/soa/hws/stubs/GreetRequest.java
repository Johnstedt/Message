...
/**
 *  GreetRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GreetRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GreetRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GreetRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GreetRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GreetRequest object = new GreetRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GreetRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GreetRequest) se.umu.cs.edu.soa.hws.stubs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
